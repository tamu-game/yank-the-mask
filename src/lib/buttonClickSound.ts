const BUTTON_CLICK_URL = "/music/button_click.mp3";
...
const getFallbackAudio = () => {
  ...
  fallbackAudio = new Audio(BUTTON_CLICK_URL);
...
const loadBuffer = async () => {
  ...
  loadingPromise = fetch(BUTTON_CLICK_URL)
...
export const preloadButtonClickSound = () => {
  void loadBuffer();
};
